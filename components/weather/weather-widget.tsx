  ...
  return (
    <>
      <button
        ...
        className="group hidden items-center gap-2 rounded-full border border-border/60 bg-background/50 px-3 py-1.5 text-xs backdrop-blur-md transition-all hover:border-accent/60 hover:bg-accent/10 xl:flex"
        aria-label="切换天气地区"
      >

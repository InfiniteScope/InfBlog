  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="rounded-xl border border-border bg-card/50 p-3 transition-colors hover:border-accent/40">
          <Eye className="mb-1.5 h-3.5 w-3.5 text-accent" />
          <p className="font-mono text-lg font-medium leading-none tabular-nums">
